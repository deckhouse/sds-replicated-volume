...
func (d *Driver) NodeStageVolume(_ context.Context, request *csi.NodeStageVolumeRequest) (*csi.NodeStageVolumeResponse, error) {
	...
	// Prefer PublishContext (controller-provided) over VolumeContext
	if v, ok := request.PublishContext[internal.VGNameKey]; ok && v != "" {
		context[internal.VGNameKey] = v
	}
	if v, ok := request.PublishContext[internal.ThinPoolNameKey]; ok {
		context[internal.ThinPoolNameKey] = v
	}
...
func (d *Driver) NodePublishVolume(_ context.Context, request *csi.NodePublishVolumeRequest) (*csi.NodePublishVolumeResponse, error) {
	...
	// Prefer PublishContext for publish phase as well
	if v, ok := request.PublishContext[internal.VGNameKey]; ok && v != "" {
		request.VolumeContext[internal.VGNameKey] = v
	}
	if v, ok := request.PublishContext[internal.ThinPoolNameKey]; ok {
		request.VolumeContext[internal.ThinPoolNameKey] = v
	}
