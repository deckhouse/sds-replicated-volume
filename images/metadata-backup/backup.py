...
if __name__ == "__main__":
    ...
    label = 'sds-replicated-volume.deckhouse.io/linstor-db-backup'
    create_backup(backup_type=date_time, namespace=namespace, labels={label: f'{date_time}'})
    body = kubernetes.client.V1Secret(
        api_version="v1",
        kind="Secret",
    ...
    namespace_secrets = kubernetes.client.CoreV1Api().list_namespaced_secret(namespace=namespace, label_selector=f"label=f{date_time}")
