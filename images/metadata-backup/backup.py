...
if __name__ == "__main__":
    ...
    namespace_secrets = kubernetes.client.CoreV1Api().list_namespaced_secret(namespace=namespace, label_selector={'sds-replicated-volume.deckhouse.io/linstor-db-backup': ''})
