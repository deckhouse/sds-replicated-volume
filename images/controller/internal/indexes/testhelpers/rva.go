...
// WithRVAByReplicatedVolumeNameIndex registers the IndexFieldRVAByReplicatedVolumeName index
// on a fake.ClientBuilder. This is useful for tests that need to use the index.
func WithRVAByReplicatedVolumeNameIndex(b *fake.ClientBuilder) *fake.ClientBuilder {
