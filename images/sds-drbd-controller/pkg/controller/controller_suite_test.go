...
func getTestAPIStorageClasses(ctx context.Context, cl client.Client) (map[string]v1alpha1.DRBDStorageClass, error) {
	resources := &v1alpha1.DRBDStorageClassList{
		TypeMeta: metav1.TypeMeta{
			Kind:       "DRBDStorageClass",
			APIVersion: "storage.deckhouse.io/v1alpha1",
		},
		ListMeta: metav1.ListMeta{},
		Items:    []v1alpha1.DRBDStorageClass{},
	}
	...
	classes := make(map[string]v1alpha1.DRBDStorageClass, len(resources.Items))
