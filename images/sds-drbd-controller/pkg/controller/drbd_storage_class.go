...
const (
	...
	StorageClassProvisioner        = "drbd.csi.storage.deckhouse.io"
	...
	// DRBDControllerPlacementCount = "drbd.csi.storage.deckhouse.io/placementCount"
	// DRBDOperatorStoragePool        = "drbd.csi.storage.deckhouse.io/storagePool"
	// AutoQuorum                     = "property.drbd.csi.storage.deckhouse.io/DrbdOptions/auto-quorum"

	StorageClassPlacementCountKey                 = "drbd.csi.storage.deckhouse.io/placementCount"
	StorageClassAutoEvictMinReplicaCountKey       = "property.drbd.csi.storage.deckhouse.io/DrbdOptions/AutoEvictMinReplicaCount"
	StorageClassStoragePoolKey                    = "drbd.csi.storage.deckhouse.io/storagePool"
	StorageClassParamReplicasOnDifferentKey       = "drbd.csi.storage.deckhouse.io/replicasOnDifferent"
	StorageClassParamReplicasOnSameKey            = "drbd.csi.storage.deckhouse.io/replicasOnSame"
	StorageClassParamAllowRemoteVolumeAccessKey   = "drbd.csi.storage.deckhouse.io/allowRemoteVolumeAccess"
	StorageClassParamAllowRemoteVolumeAccessValue = "- fromSame:\n  - topology.kubernetes.io/zone"

	StorageClassParamFSTypeKey                     = "csi.storage.k8s.io/fstype"
	FsTypeExt4                                     = "ext4"
	StorageClassParamPlacementPolicyKey            = "drbd.csi.storage.deckhouse.io/placementPolicy"
	PlacementPolicyAutoPlaceTopology               = "AutoPlaceTopology"
	StorageClassParamNetProtocolKey                = "property.drbd.csi.storage.deckhouse.io/DrbdOptions/Net/protocol"
	NetProtocolC                                   = "C"
	StorageClassParamNetRRConflictKey              = "property.drbd.csi.storage.deckhouse.io/DrbdOptions/Net/rr-conflict"
	RrConflictRetryConnect                         = "retry-connect"
	StorageClassParamAutoQuorumKey                 = "property.drbd.csi.storage.deckhouse.io/DrbdOptions/auto-quorum"
	SuspendIo                                      = "suspend-io"
	StorageClassParamAutoAddQuorumTieBreakerKey    = "property.drbd.csi.storage.deckhouse.io/DrbdOptions/auto-add-quorum-tiebreaker"
	StorageClassParamOnNoQuorumKey                 = "property.drbd.csi.storage.deckhouse.io/DrbdOptions/Resource/on-no-quorum"
	StorageClassParamOnNoDataAccessibleKey         = "property.drbd.csi.storage.deckhouse.io/DrbdOptions/Resource/on-no-data-accessible"
	StorageClassParamOnSuspendedPrimaryOutdatedKey = "property.drbd.csi.storage.deckhouse.io/DrbdOptions/Resource/on-suspended-primary-outdated"
	PrimaryOutdatedForceSecondary                  = "force-secondary"

	StorageClassParamAutoDiskfulKey             = "property.drbd.csi.storage.deckhouse.io/DrbdOptions/auto-diskful"
	StorageClassParamAutoDiskfulAllowCleanupKey = "property.drbd.csi.storage.deckhouse.io/DrbdOptions/auto-diskful-allow-cleanup"
