...
// drbdmPredicates returns predicates for DRBDMapper filtering.
	...
	return []predicate.Predicate{
		predicate.Funcs{
			CreateFunc: func(e event.TypedCreateEvent[client.Object]) bool {
				obj, ok := e.Object.(*v1alpha1.DRBDMapper)
				return ok && obj.Spec.NodeName == nodeName
			},
			UpdateFunc: func(e event.TypedUpdateEvent[client.Object]) bool {
				obj, ok := e.ObjectNew.(*v1alpha1.DRBDMapper)
				return ok && obj.Spec.NodeName == nodeName
			},
