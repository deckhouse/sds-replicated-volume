...
require (
	...
	github.com/deckhouse/sds-replicated-volume/api v0.0.0-20241204120753-0699a1ebee5e
...
require (
	...
	github.com/deckhouse/sds-node-configurator/api v0.0.0-20250228082808-5bf6fc7e70ac // indirect
