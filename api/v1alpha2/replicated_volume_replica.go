...
// +kubebuilder:printcolumn:name="Diskless",type=string,JSONPath=".spec.volumes[0].disk==\"\""
...
// +kubebuilder:printcolumn:name="Devices",type=string,JSONPath=".status.conditions[?(@.type=='DevicesReady')].status"
