...
// +kubebuilder:printcolumn:name="Resilient",type=string,JSONPath=".status.conditions[?(@.type=='Resilient')].reason"
// +kubebuilder:printcolumn:name="Layout",type=string,JSONPath=".status.membershipLayout"
