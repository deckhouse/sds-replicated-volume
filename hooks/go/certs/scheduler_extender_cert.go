...
var SchedulerExtenderCertConfig = tlscertificate.MustNewGenSelfSignedTLSGroupHookConf(
	tlscertificate.GenSelfSignedTLSHookConf{
		...
		CommonCACanonicalName: "linstor-scheduler-extender-ca",
		CASecretName:          "linstor-scheduler-extender-ca",
		CAValuesPath:          fmt.Sprintf("%s.internal.schedulerExtenderCA", ModuleName),
