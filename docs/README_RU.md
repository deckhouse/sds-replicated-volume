...
- Создайте пулы хранения и соответствующие StorageClass'ы.
  ...
  После активации модуля `sds-replicated-volume` в конфигурации Deckhouse кластер автоматически настроится на работу с бэкендом LINSTOR. Вам останется лишь выполнить создание [пулы хранения и StorageClass'ы](./usage.html#конфигурация-бэкенда-linstor).
