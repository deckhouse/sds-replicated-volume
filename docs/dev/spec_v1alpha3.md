...
- Размещение `Diskful`
  ...
  - учитываем topology:
    ...
    - `TransZonal` - реплики распределяются равномерно по зонам
      ...
      - если невозможно поддержать равномерное распределение - ошибка невозможности планирования
...
- Размещение `TieBreaker`
  - исключаем из планирования узлы, на которых уже есть реплики этой RV (любого типа)
  - учитываем topology:
    - `Zonal` - TieBreaker размещается в той же зоне, где уже есть Diskful реплики
      - если Diskful реплик нет - ошибка невозможности планирования
...
FD - без базовых реплик - это не FD?
