...
stateDiagram-v2
    ...
    migration_enabled --> all_completed : ConfigMap doesn't exist fresh install
    migration_enabled --> prepare_mig : ConfigMap exists state not started
...
sequenceDiagram
    ...
    alt ConfigMap exists and not all_completed state
        ...
        Templates->>Templates: No migration needed, skip Migration Job
    end
