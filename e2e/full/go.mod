...
replace github.com/deckhouse/sds-replicated-volume/e2e/pkg/framework => ../pkg/framework

replace github.com/deckhouse/sds-replicated-volume/e2e/pkg/debug => ../pkg/debug
