module github.com/deckhouse/sds-replicated-volume/e2e/pkg/framework
...
replace github.com/deckhouse/sds-replicated-volume/e2e/pkg/debug => ../debug

replace github.com/deckhouse/sds-replicated-volume/lib/go/testkit => ../../../lib/go/testkit

require (
	github.com/deckhouse/sds-node-configurator/api v0.0.0-20260518075128-a8e9d7072d78
	github.com/deckhouse/sds-replicated-volume/api v0.0.0-00010101000000-000000000000
	github.com/deckhouse/sds-replicated-volume/e2e/pkg/debug v0.0.0-00010101000000-000000000000
