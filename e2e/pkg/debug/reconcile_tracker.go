...
// per (controller, name) key for reconcile boundary separator drawing.
...
// NewReconcileIDTracker creates a new tracker.
func NewReconcileIDTracker() *ReconcileIDTracker {
	return &ReconcileIDTracker{m: map[string]string{}}
}

// Swap atomically replaces the reconcileID for the given key and returns
// the previous value.
